...
<body class="skin layout-boxed sidebar-mini">
    <!-- Site wrapper -->
    <div class="wrapper">

        <header class="main-header">
            <a href="<?php echo base_url();?>pengawas/C_home" class="logo"><b>DPMD</b></a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown tasks-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">You Not have tasks</li>
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
                                        <li><!-- Task item -->
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url('assets/AdminLTE-2.0.5/dist/img/logo2.png') ?>" class="user-image" alt="User Image"/>
