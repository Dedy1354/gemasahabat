...
<body class="skin-blue layout-boxed sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="<?php echo base_url();?>admin/C_home" class="logo"><b>DPMD</b></a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url('assets/AdminLTE-2.0.5/dist/img/anggota.png') ?>" class="user-image" alt="User Image"/>
