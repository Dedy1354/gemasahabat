                  ...
                  <form action="<?= base_url('admin/C_keluarga/proses_detail_data_keluarga')?>" method="POST" class="form-horizontal">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Nama Alamat/dusun</label>
                    ...
                    <div class="box-header">
                      <a href="<?php echo base_url(); ?>pengawas/C_keluarga"><submit class="btn btn-default pull-left">Kembali</submit></a>
                    </div>
                    <!-- /.box-footer -->
                  </form>
                </div>
