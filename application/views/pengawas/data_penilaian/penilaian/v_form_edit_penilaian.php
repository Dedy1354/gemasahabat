...
<!-- Content Header (Page header) -->
      <section class="content">
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url('pengawas/C_penilaian/proses_edit_data_penilaian') ?>" method="POST" class="form-horizontal">
              <div class="box-body">
              ...
              <div class="box-header">
                <a href="<?php echo base_url(); ?>pengawas/C_penilaian"><submit class="btn btn-default pull-center">Kembali</submit></a>
