               ...
               <section class="content">
                  <div class="box box-primary">
                    ...
                    <div class="box-body">
                      ...
                      <form action="<?= base_url('pengawas/C_penilaian/proses_tambah_data_penilaian') ?>" method="POST" class="form-horizontal">
                      <div class="box-body">
                        <div class="box box-primary">
                      ...
                      <table id="example1" class="table table-bordered table-striped text-center">
                       <thead>
                        ...
                        <tr>
                          ...
                          <td align="center">
                              <a href="<?php echo base_url(); ?>pengawas/C_penilaian/detail_data_penilaian/<?php echo $tampil->ID_PENILAIAN ?>"><submit class="btn btn-info btn-sm"> <i class="fa fa-eye"></i></submit></a>
                              <a href="<?php echo base_url(); ?>pengawas/C_penilaian/edit_data_penilaian/<?php echo $tampil->ID_PENILAIAN ?>"><submit class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></submit></a>
                              <a href="<?php echo base_url(); ?>pengawas/C_penilaian/hapus_data_penilaian/<?php echo $tampil->ID_PENILAIAN ?>" onclick="return confirm('anda yakin akan menghapus penilaian dengan ID  <?php echo $tampil->ID_PENILAIAN ?> atas Nama <?php echo $tampil->KEPALA_KELUARGA ?>')"><submit class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i></submit></a>
                              </a>
                          </td>
                        </tr>
                        <?php } ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
      $('#keluarga').change(function(){
        var id = $(this).val();
        $.get("<?php echo base_url()?>pengawas/C_penilaian/nama_kepalakeluarga/"+id, function(data)
        {
          $('#nama_kepalakeluarga').val(data);
        });
         $.get("<?php echo base_url()?>pengawas/C_penilaian/nama_kecamatan/"+id, function(data)
        {
          $('#nama_kecamatan').val(data);
        });
         $.get("<?php echo base_url()?>pengawas/C_penilaian/nama_desa/"+id, function(data)
        {
          $('#nama_desa').val(data);
        });
         $.get("<?php echo base_url()?>pengawas/C_penilaian/nama_alamat/"+id, function(data)
        {
      ...
      $('#nama_kriteria').change(function(){
          var id = $(this).val();       
        $.get("<?php echo base_url()?>index.php/pengawas/C_penilaian/nilai_bobot_kriteria/"+id, function(data)
        {
          $('#bobot_kriteria').val(data);
        });
        
        $("#subkriteria").load("<?php echo base_url()?>index.php/pengawas/C_penilaian/pilih_subkriteria/"+id);
      ...
      $('#subkriteria').change(function(){
        var id = $(this).val();
        $.get("<?php echo base_url()?>index.php/pengawas/C_penilaian/nilai_bobot_subkriteria/"+id, function(data)
        {
