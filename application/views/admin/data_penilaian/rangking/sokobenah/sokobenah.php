...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Data Sokobenah</li>
    </ol>
</section>
      ...
      <section class="content">
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title">Form Data Sokobenah</h3>
                  </div>
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped text-center">
                    <div>
                      <a href="<?php echo base_url(); ?>admin/C_rangking/sokobenah"><i class="fa "></i>Lihat Rangking</a>
                    </div>
                     <thead>
                        <tr>
                      ...
                      <?php 
                        $no = 1;
                        foreach ($data_sokobenah as $tampil) {
                      ?>
                      <tr>
                        <td><?php echo $no++; ?></td>
