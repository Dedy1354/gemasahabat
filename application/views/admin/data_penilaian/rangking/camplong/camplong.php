      ...
      <section class="content">
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title">Form Data Penilaian Camplong</h3>
                  </div>
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped text-center">
                    <div>
                      <a href="<?php echo base_url(); ?>admin/C_rangking/camplong"><i class="fa "></i>Lihat Rangking</a>
                    </div>
                     <thead>
                        <tr>
                      ...
                      <?php 
                        $no = 1;
                        foreach ($data_camplong as $tampil) {
                      ?>
                      <tr>
                        <td><?php echo $no++; ?></td>
