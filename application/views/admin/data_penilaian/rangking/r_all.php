      ...
      <section class="content">
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title">Form Hasil Rangking</h3>
                  </div>
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped text-center">
                    <div class="icon">
                      <a href="<?php echo base_url(); ?>admin/C_rangking/export_excel_rangking_all"><i class="fa fa-file-excel-o"></i>Excel</a>
                      <a href="<?php echo base_url(); ?>admin/C_rangking/export_pdf_rangking_all"><i class="fa fa-file-pdf-o"></i>pdf</a>
                    </div>
                     ...
                     <thead>
                      ...
                      <tr>
                        ...
                        <td align="center">
                             <a href="<?php echo base_url(); ?>admin/C_rangking/detail_data_keluarga/<?php echo $tampil->ID_KELUARGA ?>"><submit class="btn btn-info btn-sm"> <i class="fa fa-eye"></i>Detail</submit></a>
                        </td>
                      </tr>
                      <?php } ?>
                      </tbody>
