...
class C_penilaian extends CI_Controller {
	...
	function __construct() {
		...
		$this->load->model('admin/M_penilaian');
	...
	public function index()
	{
		...
		$this->load->view('admin/data_penilaian/penilaian/all_penilaian',$data);
	}
	public function nilai($ID_KELUARGA)
	{

		$where["ID_KELUARGA"] = $ID_KELUARGA;
		$data['penilaian'] = $this->M_penilaian->get($ID_KELUARGA);	
		$this->load->view('admin/data_penilaian/penilaian/v_penilaian_all',$data);
	}
	public function all_penilaian() {
		$table = 'penilaian';
        $id = "ID_PENILAIAN";
        $kode = "1";
        $karakter = "PEN-";
		...
		$data ["daftar_penilaian"] = $this->M_penilaian->get_data();

		$this->load->view('admin/data_penilaian/penilaian/v_penilaian', $data);
	}
	...
	public function proses_tambah_data_penilaian()
	{
		...
		redirect('admin/C_penilaian/index');
	}
	...
	public function detail_data_penilaian($ID_PENILAIAN)
	{
		...
		$this->load->view('admin/data_penilaian/penilaian/v_form_detail_penilaian', $data);
	}
	...
	public function edit_data_penilaian($ID_PENILAIAN)
	{
		...
		$this->load->view('admin/data_penilaian/penilaian/v_form_edit_penilaian', $data);
	}
	...
	public function banyuates()
	{
        ...
        $data['kodeunik'] = $this->M_kod->m_kodeunik($id, $table, $kode, $karakter);
		$data['tampil_kriteria'] = $this->M_penilaian->m_kriteria();
		$data ["daftar_penilaian"] = $this->M_penilaian->get_data_banyuates();

		$this->load->view('admin/data_penilaian/penilaian/p_banyuates/vp_banyuates', $data);
	}
}