...
class M_penilaian extends CI_Model {
	...
	{
		$sql = "SELECT NAMA_KRITERIA FROM kriteria where ID_KRITERIA= '$id_kriteria'";
		return $this->db->query($sql)->row();
	}
	public function ambil_nama_subkriteria($id_subkriteria)
	{
		$sql = "SELECT NAMA_SUBKRITERIA FROM subkriteria where ID_SUBKRITERIA= '$id_subkriteria'";
		return $this->db->query($sql)->row();
	}
